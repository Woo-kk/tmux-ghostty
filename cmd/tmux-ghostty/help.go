...
var helpNotes = []string{
	...
	`If inspect-current reports a local shell outside tmux, run "tmux-ghostty workspace bootstrap-current". If it reports an existing tmux pane, use "workspace adopt-current".`,
